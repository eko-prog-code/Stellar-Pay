...
class Wallet extends Component {
  ...
  handleScan = (data) => {
    if (data) {
      try {
        ...
        this.setState({
          scanError: "QR code tidak valid. Harap scan alamat Stellar (dimulai dengan G, 56 karakter)",
          scanResult: null,
        });
      }
    }
  ...
  toggleCamera = () => {
    this.setState((prevState) => ({
      facingMode:
        prevState.facingMode.exact === "environment" ? "user" : { exact: "environment" },
    }));
  };
    ...
    return (
      <div className="wallet-container">
        ...
        <div className="action-buttons">
          <button className="button button-primary" onClick={this.props.refreshBalances}>
            🔄 Refresh
          </button>
          <button className="button button-secondary" onClick={this.toggleScanner}>
          ...
          <div className="qr-scanner-container">
            ...
            <div className="scanner-controls">
              {hasBackCamera && (
                ...
                >
                  {facingMode.exact === "environment" ? "📱 Kamera Depan" : "📷 Kamera Belakang"}
                </button>
              )}
            </div>
            <p className="scanner-instruction">Arahkan kamera ke QR Code Stellar</p>
        ...
        {scanResult && (
          <div className="scan-result-section">
            ...
            {addressCopied && (
              <div className="copy-success-message">Alamat berhasil di salin!</div>
            )}
        ...
        {this.props.balances.filter((b) => b.asset_type !== "native").map((balance, index) => (
